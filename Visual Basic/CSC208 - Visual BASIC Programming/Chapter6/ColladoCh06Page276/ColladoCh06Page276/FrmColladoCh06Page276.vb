Public Class FrmColladoCh06Page276
    ...
    Private Sub SummaryToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SummaryToolStripMenuItem.Click
        ...
        FrmSummaryForm.TxtTotalNumOfPieces.Text = TotalPieces

        TotalEarned = DollarEarned1 + DollarEarned2 + DollarEarned3 + DollarEarned4
        FrmSummaryForm.TxtTotalPay.Text = FormatCurrency(TotalEarned)

        Average = TotalEarned / 4
        FrmSummaryForm.TxtAverage.Text = FormatCurrency(Average)
    ...
    Private Sub ClearSummarToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ClearSummarToolStripMenuItem.Click
        ...
        If button = System.Windows.Forms.DialogResult.Yes Then
            FrmSummaryForm.TxtTotalNumOfPieces.Clear()
            FrmSummaryForm.TxtTotalPay.Clear()
            FrmSummaryForm.TxtAverage.Clear()
        End If
    End Sub
    ...
    Private Sub ColorToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ColorToolStripMenuItem.Click
        ...
        FrmSummaryForm.TxtTotalNumOfPieces.ForeColor = Me.ColorDialog1.Color
        FrmSummaryForm.TxtTotalPay.ForeColor = Me.ColorDialog1.Color
        FrmSummaryForm.TxtAverage.ForeColor = Me.ColorDialog1.Color
    End Sub
    ...
    Private Sub FontToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FontToolStripMenuItem1.Click
        ...
        FrmSummaryForm.TxtTotalNumOfPieces.Font = Me.FontDialog1.Font
        FrmSummaryForm.TxtTotalPay.Font = Me.FontDialog1.Font
        FrmSummaryForm.TxtAverage.Font = Me.FontDialog1.Font
    End Sub
    ...
    Private Sub SloganToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SloganToolStripMenuItem1.Click
        If SloganToolStripMenuItem1.Checked = False Then
            Me.Label7.Hide()
        Else
            Me.Label7.Show()
        End If
    ...
    End Sub
    Private Sub LogoToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LogoToolStripMenuItem1.Click
        If Me.LogoToolStripMenuItem1.Checked = False Then
            Me.PictureBox1.Hide()
        Else
            Me.PictureBox1.Show()
        End If
