//filename: TestsCustomException.java
//Paul Collado
//CSC-162 Lab 6.2  TestScores Custom Exception Class

import java.util.Scanner;
public class TestsCustomException
{
 public static void main(String[] args)
 {
	 System.out.print("Filename: TestsCustomException.java \nPaul Collado");
	 System.out.println("\nCSC-162 Lab 6.2 TestScores Custom Exception Class\n");
	 ...
	 TestScoresCustomException testAverage = new TestScoresCustomException(scoretest1);
	 ...
	 do //Prompts user to run the program again
	 {
	 	do // Select which array user wants to use
	 	{
			 ...
			 System.out.print("Please select one of three availables array of tests: ");
	 		 ...
	 		 if(selection == 1) testAverage = new TestScoresCustomException(scoretest1);
	 		 else if(selection == 2) testAverage = new TestScoresCustomException(scoretest2);
	 		 else if(selection == 3) testAverage = new TestScoresCustomException(scoretest3);
	 		 else
	 		 {
				 selectionflag = true;
